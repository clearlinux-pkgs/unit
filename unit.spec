...
Version  : 1.26.1.1
Release  : 16
URL      : https://github.com/nginx/unit/archive/1.26.1-1/unit-1.26.1.1.tar.gz
Source0  : https://github.com/nginx/unit/archive/1.26.1-1/unit-1.26.1.1.tar.gz
...
%prep
%setup -q -n unit-1.26.1-1
cd %{_builddir}/unit-1.26.1-1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650396662
...
cp %{_builddir}/unit-1.26.1-1/LICENSE %{buildroot}/usr/share/package-licenses/unit/04319952ed7b0f3b3a70ae4d5d9f954317b8f970
cp %{_builddir}/unit-1.26.1-1/NOTICE %{buildroot}/usr/share/package-licenses/unit/ba513b4a1e275291801ded7b333cef4fadb328a7
cp %{_builddir}/unit-1.26.1-1/pkg/deb/debian/copyright %{buildroot}/usr/share/package-licenses/unit/2b58bdfaef4e00e20b2d60899003a45dd5869010
%make_install
