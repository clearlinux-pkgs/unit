...
%prep
%setup -q -n unit-1.25.0-1
cd %{_builddir}/unit-1.25.0-1
%patch1 -p1
%patch2 -p1
...
cp %{_builddir}/unit-1.25.0-1/NOTICE %{buildroot}/usr/share/package-licenses/unit/ba513b4a1e275291801ded7b333cef4fadb328a7
cp %{_builddir}/unit-1.25.0-1/pkg/deb/debian/copyright %{buildroot}/usr/share/package-licenses/unit/2b58bdfaef4e00e20b2d60899003a45dd5869010
%make_install
