...
Source0  : https://github.com/nginx/unit/archive/1.20.0-1/unit-1.20.0.1.tar.gz
...
%prep
%setup -q -n unit-1.20.0-1
cd %{_builddir}/unit-1.20.0-1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605137175
...
cp %{_builddir}/unit-1.20.0-1/LICENSE %{buildroot}/usr/share/package-licenses/unit/04319952ed7b0f3b3a70ae4d5d9f954317b8f970
cp %{_builddir}/unit-1.20.0-1/NOTICE %{buildroot}/usr/share/package-licenses/unit/0f0e8e05cbeab0357289517a5649039c3358ade2
cp %{_builddir}/unit-1.20.0-1/pkg/deb/debian/copyright %{buildroot}/usr/share/package-licenses/unit/91dd80d742c50e35c48d9789f1ae70d2bc63ef3b
%make_install
...
/usr/share/package-licenses/unit/0f0e8e05cbeab0357289517a5649039c3358ade2
/usr/share/package-licenses/unit/91dd80d742c50e35c48d9789f1ae70d2bc63ef3b
